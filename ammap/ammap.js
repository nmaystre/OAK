            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({
                        ...
                        m, b, "easeOutSine", "px"), this.yAnim = c.animate({
                        node: n
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) m = p.set(), a.hidden || (f = a.lineColorR, h = a.bulletBorderColorR), t = d.line(p, [0, 2 *
                        r
                    ], [r / 2, r / 2], f, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, t, "graph-stroke"), m.push(t), a.bullet && (a.hidden || (f = a.bulletColorR), t = d.bullet(p, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, h, a.bulletBorderAlpha)) && (d.setCN(c, t, "graph-bullet"), t.translate(r + 1, r / 2), m.push(t)), y = 0, t = r, q = r / 3;
                    else {
    ...
    d.AmMap = d.Class({
                    ...
                    if (!isNaN(h)) {
                        ...
                        if (!isNaN(q)) {
                            var h = b.initialTouchZoom * t / q,
                                ...
                                l = (b.zoomY() -
                                    l * t) * (h / k) + l * t;.1 < Math.abs(h - k) && (b.zoomTo(h, q, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    h = a.scale;
        ...
        showAsRolledOver: function(a) {
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                void 0 != c && ("MapImage" == a.objectType ? (e =
                    a.image) && e.setAttr("stroke", c) : b.setAttr("stroke", c));
        ...
        clickMapObject: function(a, b) {
            var c = this;
            b && (b.touches || isNaN(a.zoomLevel) && isNaN(a.zoomX) &&
                isNaN(a.zoomY) || c.hideBalloon());
        ...
        checkIfClickable: function(a) {
            ...
            return this.selectedObject == a && b ? !0 : this.selectedObject != a || b ? !0 === a.selectable || "MapArea" == a.objectType &&
                a.autoZoomReal || a.url || a.linkToObject || 0 < a.images.length || 0 < a.lines.length || !isNaN(a.zoomLevel) || !isNaN(a.zoomX) || !isNaN(a.zoomY) || a.description ? !0 : !1 : !1
        },
        resizeMap: function() {
            var a = this.mapSet;
            if (a) {
        ...
        zoomOut: function() {
            var a =
                this.zoomLevel() / this.zoomControl.zoomFactor;
            this.zoomTo(a)
        },
        moveLeft: function() {
        ...
        moveDown: function() {
            var a = this.zoomY() - this.zoomControl.panStepSize;
            this.zoomTo(this.zoomLevel(), this.zoomX(),
                a)
        },
        zoomX: function() {
        ...
        getAreaCenterLongitude: function(a) {
            ...
            var b = this.mapScale,
                c = this.mapSet.getBBox();
            return this.xyToCoordinates((a.x + a.width / 2 + this.diffX) *
                b - c.x * b, (a.y + a.height / 2 + this.diffY) * b - c.y * b).longitude
        },
        ...
        getXY: function(a, b, c) {
            void 0 !== a && (-1 != String(a).indexOf("%") ? (a = Number(a.split("%").join("")), c && (a = 100 - a), a = Number(a) *
                b / 100) : c && (a = b - a));
            return a
        },
        ...
        coordinatesToXY: function(a, b) {
            ...
            this.projectionFunction ? (e = this.projectionFunction(d.degreesToRadians(a), d.degreesToRadians(b)), c = this.mapScale * d.roundTo(this.x2c(d.radiansToDegrees(e[0])), 3), e = this.mapScale * d.roundTo(this.y2c(d.radiansToDegrees(e[1])),
                3)) : (c = this.longitudeToCoordinate(a), e = this.latitudeToCoordinate(b));
            return {
                x: c,
                y: e
            }
        ...
        xyToCoordinates: function(a,
            ...
            if (f = c.invert) {
                var k = this.dataProvider.leftLongitude,
                    ...
                    h = d.radiansToDegrees(c(d.degreesToRadians(h),
                        d.degreesToRadians(p))[0]);
        ...
        coordinateToLatitude: function(a, b) {
            ...
            if (this.mapSet) {
                var e = this.dataProvider,
                    g = e.bottomLatitude;
                c = e.topLatitude;
                "mercator" == e.projection ? (e = this.mercatorLatitudeToCoordinate(g), c = this.mercatorLatitudeToCoordinate(c),
                    c = 2 * d.degreesToRadians(a * (e - c) / b + c), c = d.radiansToDegrees(2 * Math.atan(Math.exp(c)) - .5 * Math.PI)) : c = a / b * (g - c) + c
            }
        ...
        init: function(a, b) {
            ...
            if (c.enabled) {
                ...
                a.svgIcons ? n.svgIcon = d.line(b, [-p / 2, 0, p / 2], [-p / 4, p / 4, -p /
                    4
                ], c.iconColor, 1, 1) : n.setIcon(a.pathToImages + "arrowDown.gif", h);
